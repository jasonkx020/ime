...
use crate::ai_handler::{ColdAiHandler, NoOpColdAiHandler};
...
pub struct ColdPathRuntime {
    ...
    ai_handler: Arc<parking_lot::RwLock<Arc<dyn ColdAiHandler>>>,
    #[cfg(feature = "plugin")]
...
impl ColdPathRuntime {
    pub fn new(data_dir: PathBuf) -> Self {
        ...
        let ai_handler: Arc<parking_lot::RwLock<Arc<dyn ColdAiHandler>>> =
            Arc::new(parking_lot::RwLock::new(Arc::new(NoOpColdAiHandler)));
        let ai_for_thread = ai_handler.clone();
        #[cfg(feature = "plugin")]
    ...
    pub fn set_ai_handler(&self, handler: Arc<dyn ColdAiHandler>) {
        *self.ai_handler.write() = handler;
    }
