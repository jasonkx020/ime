...
fn main() {
    ...
    let _ = writeln!(
        ...
        app.fixture("assets/dist/zh-pack-v1.imepack").display()
    );
    ...
    for line in stdin.lock().lines() {
        ...
        if line == "/help" {
            ...
            let skin = app.fixture("assets/dist/samsung-light.imeskin");
            if skin.exists() {
            ...
            let path = if rest.contains('/') || rest.contains('\\') {
                ...
                app.fixture(&format!("assets/dist/{}.imeskin", rest.trim()))
            };
            if !path.exists() {
            ...
            let pack = app.fixture("assets/dist/vi-v1.imepack");
